...
\begin{theorem}[Primitive Peripheral Spectrum]
\label{thm:ergodic-peripheral}
For primitive systems, the peripheral spectrum is $\{0\}$ (no oscillations). Equivalently: ergodic + trivial peripheral spectrum defines primitivity.
\end{theorem}
