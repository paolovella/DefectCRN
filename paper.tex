...
lake build
\end{verbatim}
The build completes with zero errors and zero \texttt{sorry} placeholders.
...
\midrule
\texttt{Basic.lean} & Core Onsager--Rayleigh theory & 852 & 25 \\
\texttt{CRNT.lean} & Species, deficiency, mass-action & 513 & 15 \\
\texttt{Examples/Triangle.lean} & 3-cycle verification & 319 & 8 \\
\texttt{Examples/Cycle.lean} & $n$-cycle parametric & 438 & 8 \\
\texttt{Examples/MichaelisMenten.lean} & Enzyme kinetics & 407 & 10 \\
\midrule
\textbf{Total} & & \textbf{2529} & \textbf{66} \\
\bottomrule
\end{tabular}
