...
The classical framework---comprising \textbf{7930 lines} of Lean 4 code with \textbf{255 theorems} and \textbf{zero axioms}---has been formally verified using the Mathlib library. The quantum extension adds \textbf{7477 lines} with \textbf{329 theorems} and \textbf{20 well-documented axioms}, including the \textbf{main classification theorem} $\delta_Q = \delta_{\mathrm{cen}}$ connecting dynamical and algebraic invariants under faithful stationary states. We demonstrate the theory on examples ranging from the simple $n$-cycle to the complete TCA (Krebs) cycle with 16 species and 10 reactions. This constitutes the first machine-checked formalization of comprehensive chemical reaction network theory, including its quantum generalization.
\end{abstract}
...
By ``formally verified,'' we mean that every definition, theorem, and proof has been machine-checked in the Lean 4 proof assistant, yielding 15,610 total lines of code with 594 theorems across 43 files. The classical CRNT portion is fully axiom-free; the quantum extension uses 20 well-documented axioms for deep results requiring additional Mathlib infrastructure (Wedderburn structure, Evans--H\o egh-Krohn theorem, spectral analysis).
...
\midrule
Lines of code & 7930 & 7477 \\
Theorems/Lemmas & 255 & 329 \\
\texttt{sorry} (unproven) & 0 & 0 \\
Axioms & 0 & 20 \\
Warnings & 0 & 0 \\
Files & 28 & 15 \\
\midrule
\textbf{Total} & \multicolumn{2}{r}{\textbf{15,407 lines, 584 theorems, 43 files}} \\
\bottomrule
\end{tabular}
\end{center}

The quantum axioms (20 total) represent deep results requiring Mathlib infrastructure:
\begin{enumerate}
...
\begin{enumerate}
    \item \textbf{Quantum axiom elimination}: Convert the 5 quantum axioms to theorems as Mathlib gains:
    \begin{itemize}
...
\midrule
\textbf{Total} & & \textbf{15,610} & \textbf{594} \\
\bottomrule
\end{tabular}
